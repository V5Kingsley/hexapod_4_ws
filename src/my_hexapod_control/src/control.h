...
public:
  ...
  void publishJointStates( const hexapod_msgs::LegsJoints &legs, int &cycle_period_, std::vector<int> &cycle_leg_number_, const hexapod_msgs::FeetPositions *feet, const bool& is_travelling); 
  void robotInit();
